...
const ConfirmModal = ({ isOpen, onClose, onConfirm, title, message, confirmText = "Xác nhận", cancelText = "Hủy", type = "danger" }) => {
            ...
            case 'danger':
                return (
                    <div className="relative mb-6">
                        ...
                        <div className="relative w-20 h-20 rounded-[2.5rem] bg-gradient-to-br from-rose-50 to-white flex items-center justify-center text-rose-500 shadow-inner border border-rose-100/50">
            ...
            case 'warning':
                return (
                    <div className="relative mb-6">
                        ...
                        <div className="relative w-20 h-20 rounded-[2.5rem] bg-gradient-to-br from-amber-50 to-white flex items-center justify-center text-amber-500 shadow-inner border border-amber-100/50">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    // backdrop-filter stays in compositor layer, no repaint on open
    return (
        <div
        ...
        >
            <div
                className="relative bg-white/90 backdrop-blur-2xl w-full max-w-sm rounded-[3.5rem] p-12 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.25)] border border-white/40 flex flex-col items-center text-center"
                style={{
                    transform: isOpen ? 'scale(1) translateY(0)' : 'scale(0.94) translateY(16px)',
                    opacity: isOpen ? 1 : 0,
            ...
            >
                ...
                <div className="flex flex-col w-full gap-4">
                    <button
                        ...
                        className={`relative w-full py-5 rounded-[2rem] font-black text-sm tracking-widest uppercase transition-all active:scale-95 overflow-hidden shadow-2xl ${
                            type === 'danger'
